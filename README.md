...
The SSP Acapulco (Secretaría de Seguridad Pública de Acapulco) manages payroll for 2,117 officers through physical pay slips issued bi-weekly by the City Hall. Before SICAD, the process required employees to identify themselves verbally — the desk operator would locate their name on a list and hand them the slip for a handwritten signature. No digital record. No traceability.
